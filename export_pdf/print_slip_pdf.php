...
// if ($payment->mem_id > 0) {
//     $pdf->SetXY(5, $line * (count($itemsData) + 8));
...
//     $pdf->SetXY(5, $line * (count($itemsData) + 9));
//     $pdf->Cell(31, 7, iconv("UTF-8", "cp874", "เงินทอน"), 0, 0, "L");
//     $pdf->Cell(
//         40,
//         7,
//         iconv("UTF-8", "cp874", $payment->money . " บาท"),
//         0,
//         0,
//         "R"
//     );
...
//             "UTF-8",
//             "cp874",
//             number_format($payment->money + $payment->order_total) . " บาท"
//         ),
//         0,
//         0,
//         "R"
...
//         40,
//         7,
//         iconv("UTF-8", "cp874", number_format($payment->money) . " บาท"),
//         0,
//         0,
//         "R"
//     );
...
// if ($payment->mem_id > 0) {
//     $mem = $db
//         ->qty("SELECT * FROM tb_member WHERE mem_id = '" . $payment->mem_id . "'")
//         ->fetch_object();
...
//             "UTF-8",
//             "cp874",
//             "สมาชิก คุณ " . $mem->mem_firstname . " " . $mem->mem_lastname
//         ),
//         0,
//         0,
//         "L"
...
//             "cp874",
//             "ได้แต้ม " .
//                 date("d/m/", strtotime($payment->order_date)) .
//                 "" .
//                 substr($payment->order_date, 0, 4) +
//                 543
//         ),
//         0,
//         0,
...
//             "UTF-8",
//             "cp874",
//             "แต้มสะสมคงเหลือ " . number_format($mem->mem_point) . " คะแนน"
//         ),
//         0,
//         0,
//         "L"

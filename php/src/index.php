...
<body>
    ...
    <script src="assets/js/datatable/datatables/datatable.customs4.js"></script>
     ...
     <script src="assets/js/datatable/datatable-extension/custom1.js"></script>
    <script src="assets/js/chat-menu.js"></script>
    ...
    <script src="assets/js/form/payment-validation-customs1.js"></script>
    ...
    <script src="assets/js/form/transaction-validation-custom.js "></script>
    <script src="assets/js/form/payment-transport-validation-custom1.js "></script>
    ...
    <script src="assets/js/chart/chartjs/chart.custom1.js"></script>
    <script src="assets/js/chat-menu.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->

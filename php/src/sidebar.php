    ...
    <div class="sidebar">
        <ul class="iconMenu-bar custom-scrollbar">
            <?php if ($_SESSION["user_role"] == 2) { ?>
                ...
                <?php } ?>
                <li><a class="bar-icons" href="?p=transport"><i class="pe-7s-box2"></i><span>ระบบจัดการขนส่ง</span></a>
                <li><a class="bar-icons" href="?p=categories"><i class="pe-7s-box2"></i><span>ระบบจัดการประเภท</span></a>
                <li><a class="bar-icons" href="?p=transaction"><i class="pe-7s-graph1"></i><span>ระบบจัดการรายรับรายจ่าย</span></a>
